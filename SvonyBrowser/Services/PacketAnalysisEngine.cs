...
namespace SvonyBrowser.Services
{
    ...
    public class PacketAnalysisEngine : INotifyPropertyChanged, IDisposable
    {
        ...
        private readonly ConcurrentDictionary<string, PacketPattern> _patterns = new ConcurrentDictionary<string, PacketPattern>();
        private readonly ConcurrentDictionary<string, ProtocolAction> _learnedActions = new ConcurrentDictionary<string, ProtocolAction>();
